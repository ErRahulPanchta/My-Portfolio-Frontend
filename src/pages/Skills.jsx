...
import {
  SiNextdotjs, SiExpress, SiMongodb, SiTailwindcss,
  SiJavascript, SiPostman, SiJsonwebtokens, SiTypescript, SiMongoose
} from 'react-icons/si';
...
const Skills = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Skills | Rahul Panchta | MERN Stack Developer</title>
        <meta
          name="description"
          content="Explore Rahul Panchta's technical skills including React.js, Node.js, MongoDB, Express, Tailwind CSS, and tools like Git, Postman, and VS Code."
        />
        <link
          rel="canonical"
          href="https://my-portfolio-frontend-nu-three.vercel.app/skills"
        />
      </Helmet>
