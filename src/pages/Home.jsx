...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Rahul Panchta | Full Stack Developer | Home</title>
        <meta
          name="description"
          content="Welcome to the portfolio of Rahul Panchta — a Full Stack MERN Developer building modern, responsive, and high-performance web applications."
        />
        <link
          rel="canonical"
          href="https://my-portfolio-frontend-nu-three.vercel.app/"
        />
      </Helmet>
      ...
      <section className="flex flex-col items-center justify-center min-h-screen py-12 px-6 bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              to="/projects"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-full shadow-md hover:shadow-lg transition-all"
            >
              View My Work
            </Link>
            <a
